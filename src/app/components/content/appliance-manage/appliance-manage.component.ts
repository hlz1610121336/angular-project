...
@Component({
  selector: 'app-appliance-manage',
  templateUrl: './appliance-manage.component.html',
  styleUrls: ['./appliance-manage.component.css'],
  providers: [ WindowHeightInitService, LocalStorageService]
})
export class ApplianceManageComponent implements OnInit {
